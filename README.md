...
Copy this code ((.cpp)[https://github.com/JRL-CARI-CNR-UNIBS/installation/blob/master/log.cpp], (.h)[https://github.com/JRL-CARI-CNR-UNIBS/installation/blob/master/log.h]) in your class to set color for `ROS_INFO_STREAM`
